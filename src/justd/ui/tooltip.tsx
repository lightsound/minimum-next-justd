...
function Tooltip(props: React.ComponentProps<typeof TooltipTrigger>) {
  // eslint-disable-next-line react/prefer-destructuring-assignment
  return <TooltipTrigger {...props}>{props.children}</TooltipTrigger>
}
...
function Content({ showArrow = true, intent = 'default', children, ...props }: ContentProps) {
  return (
    <TooltipPrimitive
      {...props}
      offset={10}

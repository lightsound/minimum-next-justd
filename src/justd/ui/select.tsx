...
import type { ButtonProps, SelectProps as SelectPrimitiveProps, ValidationResult } from 'react-aria-components'
...
function List<T extends object>({ className, children, items, placement }: ListProps<T>) {
  return (

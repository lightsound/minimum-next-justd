...
import type { DialogProps, DialogTriggerProps, Modal, ModalOverlayProps as ModalOverlayPrimitiveProps } from 'react-aria-components'
...
function Sheet({ children, ...props }: DialogTriggerProps) {

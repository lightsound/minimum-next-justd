...
function Title({ level = 2, className, ...props }: TitleProps) {
  return <Heading slot="title" level={level} className={titleStyles({ level, className })} {...props} />
}
...
function Close({ className, appearance = 'outline', ...props }: ButtonProps) {

...
function Title({ level = 2, className, ...props }: React.ComponentProps<typeof Dialog.Title>) {
  return (
    <Dialog.Title
...
function Header({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <Dialog.Header className={cn('p-0 sm:pt-0', className)} {...props} />
}

function Footer({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <Dialog.Footer className={cn('pb-0 pt-4 sm:pb-0', className)} {...props} />
}

function Body({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <Dialog.Body className={cn('sm:p-0', className)} {...props} />
}
